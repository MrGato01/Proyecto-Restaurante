    ...
    public class UsuarioRepositorio : IUsuarioRepositorio
    {
        ...
        public async Task<bool> ActualizarAsync(Usuario usuario)
        {
            ...
            try
            {
                ...
                string sql = @"UPDATE usuario SET Nombre = @Nombre, Contrasena = @Contrasena, Correo = @Correo, Rol = @Rol, Foto = @Foto, FechaCreacion = @FechaCreacion, EstaActivo = @EstaActivo 
        ...
        public async Task<bool> EliminarAsync(Usuario codigoUsuario)
        {
            bool resultado = false;
            try
            {
